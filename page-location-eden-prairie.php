<?php
/*
   Template Name: Location Eden-Prairie
*/
$contact_form = get_field('contact_form_ep');
$ep_map = get_field('location_ep');
...
<!-- HERE CAROUSEL -->
<?php get_template_part('template-parts/content','carousel-location-ep'); ?>
 ...
 <div class="container">
   <div class="row">
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 location-details">
     <h1 id="location-header">EVO BODY EDEN PRAIRIE</h1>
     <ul>
    ...
    <div class="row">
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 location-info-content">
        ...
        <h4>Call:</h4>
          <p>952-949-1131</p>
        <h4>Visit:</h4>
          <p>10165 Hennepin Town Rd. Suite 111 <br />
             Eden Prairie, MN 55347
          </p>
        <a href="https://www.google.com/maps/dir//10165+Hennepin+Town+Rd,+Eden+Prairie,+MN+55347/@44.8211253,-93.4035989,17z/data=!4m16!1m7!3m6!1s0x87f62294fd79a34f:0x2f07b30b1cf55d67!2s10165+Hennepin+Town+Rd,+Eden+Prairie,+MN+55347!3b1!8m2!3d44.8211215!4d-93.4014102!4m7!1m0!1m5!1m1!1s0x87f62294fd79a34f:0x2f07b30b1cf55d67!2m2!1d-93.4014102!2d44.8211215" target="blank"><h4 class="directions">Get Directions &#9758;</h4></a>
        <h4>Email:</h4>
      ...
      <div id="club-info-images" class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
       <div class="row maps">
         ...
         <div class="col-sm-6 col-xs-6"  id="location-meet-trainers">
           ...
           <a href="http://localhost:8888/evobody-website/eden-prairie-personal-trainers/"><button class="btn btn-default">More &#62;</button></a>
         </div>
       </div>
       <br />
       <div class="row">
