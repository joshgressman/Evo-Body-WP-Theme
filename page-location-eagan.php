<?php
/*
   Template Name: Location Eagan
*/
$contact_form = get_field('eagan-contact-form');
$eagan_map = get_field('eagan_map');
get_header();
?>

<!-- HERE CAROUSEL -->
<?php get_template_part('template-parts/content','carousel-location-eagan'); ?>
 ...
 <div class="container">
   <div class="row">
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 location-details">
     <h1 id="location-header">EVO BODY EAGAN</h1>
     <ul>
      ...
      <div id="club-info-images" class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
       <div class="row maps">
         ...
         <div class="col-sm-6 col-xs-6"  id="location-meet-trainers">
           ...
           <a href="http://localhost:8888/evobody-website/eagan-personal-trainers/"><button class="btn btn-default">More &#62;</button></a>
         </div>
       </div>
       <div class="row">
        <br />
